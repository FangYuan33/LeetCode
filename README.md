...
我重新将题目的顺序整理了一下，我认为比较合适的顺序是：双指针、滑动窗口和二分查找，接下来是数据结构链表、栈、队列、散列表等等，换个脑子学习一下排序算法，接下来就是树、图数据结构，再就是回溯、动态规划等等，最后是树状数组和线段树，我觉得这两部分内容作为扩展学习更合适。另外我也整理了 掘金 和 CSDN 的专栏，大家按照喜好看自己喜欢的网站吧，方便的话，可以在掘金上帮忙点个关注（我总觉得 CSDN 是一个没有人在运营的博客网站...），希望大家算法学习的开心~

- [算法学习指南](https://juejin.cn/post/7339042929883381795): [https://juejin.cn/post/7339042929883381795](https://juejin.cn/post/7339042929883381795)
...
| [278. 第一个错误的版本 简单](https://leetcode.cn/problems/first-bad-version)                                                    |                                                                                  |                      |
...
| [1206. 设计跳表 困难](https://leetcode.cn/problems/design-skiplist/)                    | [Skiplist.java](src/leetcode/datastructure/Skiplist.java)                                                                                                       |                                                                            |
...
- 相关学习：[单调栈和单调队列可以很简单](https://juejin.cn/post/7282007210430480418)
...
- 相关学习：[深入理解回溯算法](https://juejin.cn/post/7365741765729255474)
...
![img.png](src/leetcode/dp/动态规划二维数组字符串关系图.png)

### 记忆化搜索

| 题目链接                                                               | 题解                                                                  | 备注 |
|--------------------------------------------------------------------|---------------------------------------------------------------------|----|
| [377. 组合总和 Ⅳ 中等](https://leetcode.cn/problems/combination-sum-iv/) | [Solution377.java](src%2Fleetcode%2Fdp%2Fmemory%2FSolution377.java) |    |
...
| [1749. 任意子数组和的绝对值的最大值 中等](https://leetcode.cn/problems/maximum-absolute-sum-of-any-subarray/) | [Solution1749.java](src%2Fleetcode%2Fdp%2Ffibonacci%2FSolution1749.java) |    |
...
| [1953. 你可以工作的最大周数 中等](https://leetcode.cn/problems/maximum-number-of-weeks-for-which-you-can-work/) | [Solution1953.java](src%2Fleetcode%2Fgreedyalgorithm%2FSolution1953.java) |             |
...
| [231. 2 的幂 简单](https://leetcode.cn/problems/power-of-two/)                            | [Solution231.java](src%2Fleetcode%2Fbit%2FSolution231.java)       | 2的幂有 (n & (n - 1)) == 0 |
| [50. Pow(x, n) 中等](https://leetcode.cn/problems/powx-n/)                              | [Solution50.java](src%2Fleetcode%2Fbit%2FSolution50.java)         |                         |
| [136. 只出现一次的数字 简单](https://leetcode.cn/problems/single-number/)                       | [Solution136.java](src%2Fleetcode%2Fbit%2FSolution136.java)       |                         |
