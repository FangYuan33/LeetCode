...
| [661. 图片平滑器 简单](https://leetcode.cn/problems/image-smoother/)                         | [Solution661.java](src%2Fleetcode%2Fprefixsum%2FSolution661.java) |    |
...
| 题目链接                                                                              | 题解                                                                                                                                                              | 备注 |
|-----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|----|
| [146. LRU 缓存 中等](https://leetcode.cn/problems/lru-cache/)                         | [LRUCache.java](src%2Fleetcode%2Fdatastructure%2FLRUCache.java) <br/> [LRUCacheLinkedHashMap.java](src%2Fleetcode%2Fdatastructure%2FLRUCacheLinkedHashMap.java) |    |
...
注意，记录的区间范围为全开区间，所以如果在计算区间长度时需要减 1。
